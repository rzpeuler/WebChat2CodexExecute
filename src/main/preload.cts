...
const PROJECT_GOVERNANCE_UPGRADE_CHANNEL = 'project:governance-upgrade';
...
const rendererApi: RendererApi = {
  ...
  upgradeProjectGovernance: (config) => ipcRenderer.invoke(PROJECT_GOVERNANCE_UPGRADE_CHANNEL, config),
